...
CE = {
    ...
    "shop": ("5470041305616759456", "🎁"),
    "planet": ("5332586662629227075", "🗂"),
    "link": ("5321272434576355870", "🔗"),
    "stock": ("5348149223223211884", "📦"),
    "cart": ("5319204558147188648", "🛒"),
    "card": ("5389078268689265131", "💳"),
    "support": ("5440411975509096877", "💬"),
    "fire": ("5332336747072208845", "🔥"),
    "bolt": ("5233732076141828188", "⚡️"),
    "ok": ("5273806972871787310", "✅"),
    "cross": ("5271934564699226262", "❌"),
    "globe": ("5332618260703624145", "🌐"),
    "chart": ("5364295555772074912", "📈"),
    "spark": ("5233537411044107383", "⭐️"),
    "news_catalog": ("5366328015900914335", "🛍"),
    "news_bolt": ("5233732076141828188", "⚡️"),
    "news_money": ("5361656830944624968", "💲"),
    "news_chat": ("5440411975509096877", "💬"),
    "news_announce": ("5332369758190845562", "📩"),
    "news_question": ("5436113877181941026", "❓"),
    "news_shield": ("5363972600001216334", "🛡"),
    "news_gear": ("5366231924597604153", "⚙️"),
    "news_pencil": ("5332679880599418983", "ℹ️"),
